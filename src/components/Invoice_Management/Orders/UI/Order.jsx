                  ...
                  <tr>
                    <th className="w-1">
                      <input
                        type="checkbox"
                        checked={
                          selectAllPages_Payment[currentPage_Payment - 1]
                        }
                  ...
                  <tr>
                    <th className="w-1">
                      <input
                        type="checkbox"
                        checked={
                          selectAllPages_Outsourcing[
                            currentPage_Outsourcing - 1
                          ]
                        }
                            ...
                            <td className="w-8" name="tb_action">
                              <div className=" flex justify-center py-1 mx-1 bg-white  border-gray-500/50 border rounded-sm ">
                                <svg
                                  onClick={() => {
                                    updateState({
                                      isShowFormEditOutsourcing: true,
                                    });
                                    console.log(rowDataOutsourcing);
                                    updateState({
                                      selectedRowOutsourcing_Edit:
                                        rowDataOutsourcing,
                                    });
                                    updateState({
                                      selectedRowOutsourcing_Edit:
