          ...
          <div className="grid gap-2 items-center w-full overflow-auto">
            <div className="flex items-center justify-between">
              <div className="mt-1 px-6 flex flex-row items-center">
                ...
                <span className="font-bold">  {t_order("title.Payment_management")}</span>
              </div>
              ...
              <div className="flex flex-row">
                ...
                <Button
                  onClick={() => updateState({isShowDeleteModal_Payment: true })}
                  className="bg-red ml-2"
                  icon={
                    <svg
                      width="16"
                    ...
                    <tr key={index}>
                      ...
                      <td className="w-24" name="tb_date">
                        <input
                          className="text-center"
                          readOnly
                          value={(rowDataPayment.payment_date || "").split(" ")[0]}
                        />
                      </td>
                      <td className="w-32" name="tb_name">
                        <input
