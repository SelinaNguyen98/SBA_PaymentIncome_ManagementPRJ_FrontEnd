...
export default function EditOrderForm({ visible, cancel, t }) {
  const t_add_order = t;
  return (
    <Modal visible={visible}>
      <div className="flex flex-col bg-white m-2 py-5 px-12  rounded-2xl">
        ...
        <form className="px-4 mt-5">
          <InputCustomComponent label={t_add_order("add_edit_order.day")}>
            <input type="text" className=" bg-main-theme w-full"></input>
          </InputCustomComponent>
          <InputCustomComponent label= {t_add_order("add_edit_order.Company_name")}>
            <input type="text" className=" bg-main-theme w-full"></input>
          </InputCustomComponent>
        ...
        <div className="flex items-center justify-around  mt-6 mb-7  ">
          ...
          >
            <span className=" text-red-500  uppercase ">{t_add_order("button.cancel")}</span>
          </Button>
        </div>
      </div>
    </Modal>
