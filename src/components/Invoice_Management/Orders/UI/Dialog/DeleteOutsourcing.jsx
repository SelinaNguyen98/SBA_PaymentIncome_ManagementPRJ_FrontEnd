...
export default function DeleteOutsourcing({ visible, cancel, t, deleteOutsourcing }) {
  const t_delete = t;
  return (
    <Modal visible={visible}>
      <div className=" bg-white m-2 py-4 px-5 border-red-500 border-[3px] rounded-2xl  flex  flex-col  ">
        ...
        <div className="flex items-center justify-center space-x-5  px-4 mt-6 mb-7 ">
          <Button onClick={deleteOutsourcing} className={"  bg-red border-red-500 border-2 py-2 px-6 min-w-[120px]"}>
