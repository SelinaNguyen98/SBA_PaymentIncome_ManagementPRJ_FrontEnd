...
export default function InvoiceDetails() {
  ...
  const { isShowConfirmModal, isShowFormNewPayment, 
          isShowEditModal, isShowDeleteModal, 
          isShowAcptDelete, isShowNoAcptEdit } = state;
    ...
    <div className={`grid grid-cols-12  bg-main-theme`}>
      ...
      ></div>
        ...
        <div className="mt-1 px-6 flex flex-shrink-0 items-center ">
          ...
          <div style={{ display: 'inline-block', fontWeight: 'bold', paddingRight: '20px' } }></div>
          {t(t("titlePage.accountCategory"))}&nbsp;
          <div style={{ display: 'inline-block', marginLeft: '100px' }}></div>
          <select
            id="categoryFilter"
            value={selectedOption}
            onChange={handleOptionChange}
            style={{ width: '200px', height: '50px', backgroundColor: 'midnightblue', color: 'white', borderRadius: '10px' }}
          >
          ...
          <table id="invoiceTable" className="w-full">
            <thead>
              <tr>
                <th className=" w-[1%]"></th>
                <th className=" w-[1%]">
                  <input type="checkbox" className="" id="selectAllCheckbox" onClick={handleSelectAll}/>
                </th>
              ...
              {Array(10)
                ...
                .map((_, index) => (
                  <tr key={index}>
                    ...
                    {/* DATA MAIN*/}
                    <td className="text-left w-[1%] border-r-0 custom-no-border" name="tb_no">
                      <input type="checkbox" className="" name="tb_no"/>
                    </td>
                    <td className=" w-[5%] border-none custom-no-border" name="tb_name">
                    </td>
        ...
        <Modal visible={isShowConfirmModal}>
          <div className=" bg-white m-2 py-4 px-5 border-red-500 border-[3px] rounded-2xl  flex  flex-col  ">
            ...
            <div className="text-center pt-5 px-2 font-bold text-sm">
              ...
              <p className="text-red-600 mb-0">{t("notification.deleteCategory")}</p>
            </div>
        ...
        <Modal visible={isShowDeleteModal}>
          <div className=" bg-white m-2 py-4 px-5 border-red-500 border-[3px] rounded-2xl  flex  flex-col  ">
            ...
            <div className="text-center pt-5 px-2 font-bold text-sm">
              ...
              <p className="text-red-600 mb-0">{t("notification.delete1Category")}</p>
            </div>
        ...
        <Modal visible={isShowAcptDelete}>
          <div className=" bg-white m-2 py-4 px-5 border-red-500 border-[3px] rounded-2xl  flex  flex-col  ">
            ...
            <div className="text-center pt-5 px-2 font-bold text-sm">
              <p className="text-red-600 mb-0">{t("notification.acptDeleteCategory")}</p>
            </div>
        ...
        <Modal visible={isShowNoAcptEdit}>
          <div className=" bg-white m-2 py-4 px-5 border-red-500 border-[3px] rounded-2xl  flex  flex-col  ">
            ...
            <div className="text-center pt-5 px-2 font-bold text-sm">
              <p className="text-red-600 mb-3">{t("notification.editCategory")}</p>
